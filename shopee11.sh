...
# curl -s -L https://www.instagram.com/$account_spam 

# | grep  -o '"id":"..................[0-9]' | cut -d ":" -f2 | tr -d '"' > media_id
# counter="1"
